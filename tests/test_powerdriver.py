...
class TestManualPowerDriver:
    ...
    def test_on(self, target, mocker):
        ...
        m.assert_called_once_with("Turn the target Test ON and press enter")
    ...
    def test_off(self, target, mocker):
        ...
        m.assert_called_once_with("Turn the target Test OFF and press enter")
...
class TestExternalPowerDriver:
    ...
    def test_on(self, target, mocker):
        ...
        popen.assert_called_once_with(["set", "-1", "foo-board"], bufsize=0, stderr=2, stdout=2)
    ...
    def test_off(self, target, mocker):
        ...
        popen.assert_called_once_with(["set", "-0", "foo-board"], bufsize=0, stderr=2, stdout=2)
    ...
    def test_cycle(self, target, mocker):
        ...
        assert popen.call_args_list == [
            mocker.call(["set", "-0", "foo-board"], bufsize=0, stderr=2, stdout=2),
            mocker.call(["set", "-1", "foo-board"], bufsize=0, stderr=2, stdout=2),
        ]
    ...
    def test_cycle_explicit(self, target, mocker):
        ...
        popen.assert_called_once_with(["set", "-c", "foo-board"], bufsize=0, stderr=2, stdout=2)
